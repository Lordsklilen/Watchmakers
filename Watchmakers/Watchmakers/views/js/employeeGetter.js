...
function getEmployees() {
    $.getJSON( "/api/employees", {
      ...
      .done(function( data ) {
          ...
          items += "<button type='submit' class='btn btn-danger'>Delete user</button></form>";
          items += "</span>"
          items += "<span class='td'><button type='button' class='btn btn-warning' onclick='ShowHidden(\""+id+"\")'>Update User</button></span></div>";
